  ...
  return (
    <div className="mt-6 rounded-xl border p-3">
      ...
      <form onSubmit={submit} className="grid gap-2">
        ...
        <textarea className="field rounded-2xl min-h-[120px] resize-vertical" value={text} onChange={e=>setText(e.target.value)} placeholder="Ваш отзыв" className=" field  min-h-[100px]" />
