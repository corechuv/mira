...
export type Product = {
  ...
  price: number; oldPrice?: number; rating: number; ratingCount?: number;
  category: 'skincare'|'makeup'|'haircare'; brand: string; tags: string[];
  images: string[]; stock: number; sku: string; volume?: string;
  ingredients?: string[]; howToUse?: string[]; variants?: Variant[]; reviews?: Review[]
}
export const products: Product[] = [
  {
    ...
    category: 'skincare', brand: 'Mira', tags: ['увлажнение','сияние','anti-age'],
    images: [
    ...
    stock: 42, sku: 'MIRA-SER-HA-30', volume: '30 мл',
    ingredients: ['Гиалуроновая кислота 2%','Пантенол','Бетаин'],
    howToUse: ['Наносить на влажную кожу после тонера','Закрыть кремом'],
    variants: [
      { id: '30', name: '30 мл', price: 12.90, stock: 42 },
      { id: '50', name: '50 мл', price: 16.90, stock: 15 }
    ],
    reviews: [{ id: 'r1', author: 'Анна', rating: 5, text: 'Классное увлажнение, макияж лежит лучше.', date: '2025-06-10' }]
  },
  {
    ...
    price: 8.90, rating: 4.5, ratingCount: 128,
    category: 'skincare', brand: 'Mira', tags: ['очищение','без сульфатов'],
    images: [
      'https://images.unsplash.com/photo-1611501275019-f6b3e12dc1f2?q=80&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?q=80&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1604079628040-94301bb21b91?q=80&w=1600&auto=format&fit=crop'
    ],
    stock: 80, sku: 'MIRA-CLN-GNT-150', volume: '150 мл',
  ...
  },
  {
    ...
    price: 15.90, rating: 4.8, ratingCount: 356,
    category: 'skincare', brand: 'Mira', tags: ['spf','дневной уход'],
    images: [
      'https://images.unsplash.com/photo-1604079628040-94301bb21b91?q=80&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?q=80&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1585386959984-a41552231658?q=80&w=1600&auto=format&fit=crop'
    ],
    stock: 35, sku: 'MIRA-SPF-50L', volume: '50 мл',
  ...
  },
  {
    ...
    price: 9.90, oldPrice: 11.90, rating: 4.6, ratingCount: 98,
    category: 'makeup', brand: 'Mira', tags: ['губы','матовая'],
    images: [
      'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?q=80&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1585386959984-a41552231658?q=80&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1611501275019-f6b3e12dc1f2?q=80&w=1600&auto=format&fit=crop'
    ],
    stock: 21, sku: 'MIRA-LIP-ROSE',
  ...
  },
  {
    ...
    price: 7.90, rating: 4.4, ratingCount: 143,
    category: 'makeup', brand: 'Mira', tags: ['ресницы','объем'],
    images: [
      'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?q=80&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1611501275019-f6b3e12dc1f2?q=80&w=1600&auto=format&fit=crop'
    ],
    stock: 64, sku: 'MIRA-MSC-VOL'
  },
  {
    id: 'shampoo-repair-250',
    title: 'Шампунь восстановление 250 мл',
    description: 'Кератиновый комплекс для гладкости и блеска волос.',
    price: 6.90, rating: 4.3, ratingCount: 77,
    category: 'haircare', brand: 'Mira', tags: ['восстановление','кератин'],
    images: [
      'https://images.unsplash.com/photo-1611501275019-f6b3e12dc1f2?q=80&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?q=80&w=1600&auto=format&fit=crop'
    ],
    stock: 58, sku: 'MIRA-SHM-RPR-250', volume: '250 мл'
  },
  {
    ...
    price: 7.20, rating: 4.2, ratingCount: 65,
    category: 'haircare', brand: 'Mira', tags: ['питание','гладкость'],
    images: [
      'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?q=80&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1604079628040-94301bb21b91?q=80&w=1600&auto=format&fit=crop'
    ],
    stock: 77, sku: 'MIRA-COND-NUT-250', volume: '250 мл'
  },
  {
    ...
    price: 6.50, rating: 4.1, ratingCount: 51,
    category: 'skincare', brand: 'Mira', tags: ['ниацинамид','pH'],
    images: [
      'https://images.unsplash.com/photo-1604079628040-94301bb21b91?q=80&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1611501275019-f6b3e12dc1f2?q=80&w=1600&auto=format&fit=crop'
    ],
    stock: 90, sku: 'MIRA-TON-BAL-150', volume: '150 мл'
  },
  {
    id: 'oil-cleansing-100',
    title: 'Гидрофильное масло 100 мл',
    description: 'Эффективно растворяет SPF и макияж, не забивает поры.',
    price: 11.50, rating: 4.5, ratingCount: 84,
    category: 'skincare', brand: 'Mira', tags: ['двойное очищение'],
    images: [
      'https://images.unsplash.com/photo-1604079628040-94301bb21b91?q=80&w=1600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1585386959984-a41552231658?q=80&w=1600&auto=format&fit=crop'
    ],
    stock: 50, sku: 'MIRA-OIL-CLN-100', volume: '100 мл'
  },
  {
    id: 'hand-cream-50',
    title: 'Крем для рук 50 мл',
    description: 'Питание и защита, быстро впитывается, без липкости.',
    price: 3.90, rating: 4.0, ratingCount: 120,
    category: 'skincare', brand: 'Mira', tags: ['руки','питание'],
    images: ['https://images.unsplash.com/photo-1611501275019-f6b3e12dc1f2?q=80&w=1600&auto=format&fit=crop'],
    stock: 120, sku: 'MIRA-HAND-CRM-50', volume: '50 мл'
  }
]
